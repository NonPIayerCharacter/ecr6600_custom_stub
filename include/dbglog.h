...
#define DBGLOG_LEVEL_TRACE		6		//跟踪
#define DBGLOG_LEVEL_DEBUG		5		//调试
#define DBGLOG_LEVEL_CRITICAL	4		//严重	
#define DBGLOG_LEVEL_ERROR		3		//错误
#define DBGLOG_LEVEL_WARNING	2		//警告
#define DBGLOG_LEVEL_INFO		1		//信息
#define DBGLOG_LEVEL_NO_LOG		0		//无
